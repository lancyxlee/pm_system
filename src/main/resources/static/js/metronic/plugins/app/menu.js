...
function loadMenu() {
    ...
    var json = '[{"id": "1","name": "CSI员工之家","icon": null,"url": "","parentId": "",'
        ...
        + '"childs": []}]},{"id": "12","name": "人事管理","icon": "/xingxing.png","url": "dept/dept.html","parentId": "1",'
        ...
        + '"childs": []}]},{"id": "14","name": "薪资管理","icon": "/xingxing.png","url": "job/job.html","parentId": "1",'
        + '"childs": [{"id": "141","name": "员工工资信息","icon": "","url": "job/job.html","parentId": "14",'
        + '"childs": []},{"id": "142","name": "员工工资设置","icon": "","url": "job/showAddJob.html","parentId": "14",'
        + '"childs": []}]},{"id": "15","name": "考勤管理","icon": "/xingxing.png","url": "employee/employee.html","parentId": "1",'
    ...
    var ordinary = '[{"id": "1","name": "CSI员工之家","icon": null,"url": "","parentId": "",'
        + '"childs": [{"id": "11","name": "用户管理","icon": "/xingxing.png","url": "user/user.html","parentId": "1",'
        ...
        + '"childs": [{"id": "171","name": "文档查询","icon": "","url": "document/document.html","parentId": "17","childs": []}]}]}]';
